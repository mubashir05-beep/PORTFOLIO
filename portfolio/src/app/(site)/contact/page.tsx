...
const PageComponent: React.FC = () => {
  ...
  return (
    <div className='h-[80vh] flex items-center justify-center'>
      <form className='w-full max-w-sm p-6 rounded shadow-md' onSubmit={handleSubmit}>
        <div className='relative z-0 w-full mb-5'>
          <input
            ...
            placeholder=' '
            className={`pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 ${error.name && 'dark:border-red-800 border-red-500'} appearance-none focus:outline-none transition duration-300 focus:ring-0 focus:border-black dark:focus:border-white  border-gray-500`}
          />
