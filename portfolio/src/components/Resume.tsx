...
const Resume = () => {
  return (
    <>
      <Link href={"/resume"}>
        <div className="gap-[18px] h-[199.5px] group hover:shadow-2xl flex flex-col dark:border-white justify-evenly border border-black p-[2rem] w-[400px] max-[1495px]:w-auto max-[500px]:p-[1rem] rounded-xl">
          <h1 className="text-3xl flex py-3 justify-between items-center font-light relative group ">
            Resume
            <div className="flex items-center justify-center">
              <div className="dark:group-hover:bg-white w-[17px]  h-[22.5px] rounded-full  absolute  -z-20 dark:bg-black" />
              <MdContactPage
                size={36}
