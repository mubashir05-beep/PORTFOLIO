...
const About = () => {
  return (
    <div className="gap-[18px] min-[1600px]:max-w-[650px] cursor-pointer group hover:shadow-2xl  max-[1370px]:w-auto dark:border-white  flex flex-col justify-between border border-black p-[2rem] max-[500px]:p-[1rem] rounded-xl">
       <h1 className="text-[4.5rem] max-[600px]:text-[50px] font-light relative group ">
  About
