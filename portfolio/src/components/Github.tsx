...
const Github = () => {
  return (
    <>
      <Link href={"/"}>
        <div className="gap-[18px] group h-[199.5px] duration-300 transition hover:shadow-2xl  flex flex-col justify-evenly border dark:border-white border-black p-[2rem] w-[400px] max-[1370px]:w-auto max-[500px]:p-[1rem] rounded-xl">
