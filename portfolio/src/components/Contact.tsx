...
const Contact: React.FC = () => {
  return (
    <Link href={"/contact"}>
      <div className="group gap-[18px] h-[199.5px] flex flex-col justify-evenly border dark:border-white   border-black p-[2rem] w-[400px] max-[1495px]:w-auto max-[500px]:p-[1rem] rounded-xl hover:shadow-2xl">
        <h1 className="text-3xl flex py-3 justify-between items-center font-light relative group ">
          Contact
          <div className="flex items-center justify-center">
          <div className="dark:group-hover:bg-white w-[30px] h-[15px] rounded absolute -z-20 dark:bg-black" />
